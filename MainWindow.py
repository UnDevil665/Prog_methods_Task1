...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def readFromFile(self, filename: str):
        ...
        person = xml.Element("person")
        root.append(person)

        name = xml.SubElement(person, "name")
        name.text = "Appendo"

        surname = xml.SubElement(person, "surname")
        surname.text = "Append"

        thirdname = xml.SubElement(person, "thirdname")
        thirdname.text = "Appendovich"
